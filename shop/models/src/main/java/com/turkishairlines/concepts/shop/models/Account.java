...
public class Account extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9043334684452753937L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Account\",\"namespace\":\"com.turkishairlines.concepts.shop.models\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"phoneNumber\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.turkishairlines.concepts.shop.models.Account.Builder newBuilder() {
    return new com.turkishairlines.concepts.shop.models.Account.Builder();
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static com.turkishairlines.concepts.shop.models.Account.Builder newBuilder(com.turkishairlines.concepts.shop.models.Account.Builder other) {
    if (other == null) {
      return new com.turkishairlines.concepts.shop.models.Account.Builder();
    } else {
      return new com.turkishairlines.concepts.shop.models.Account.Builder(other);
    }
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static com.turkishairlines.concepts.shop.models.Account.Builder newBuilder(com.turkishairlines.concepts.shop.models.Account other) {
    if (other == null) {
      return new com.turkishairlines.concepts.shop.models.Account.Builder();
    } else {
      return new com.turkishairlines.concepts.shop.models.Account.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.turkishairlines.concepts.shop.models.Account.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.turkishairlines.concepts.shop.models.Account other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.turkishairlines.concepts.shop.models.Account.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.turkishairlines.concepts.shop.models.Account.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.turkishairlines.concepts.shop.models.Account.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.turkishairlines.concepts.shop.models.Account.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.turkishairlines.concepts.shop.models.Account.Builder setPhoneNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.turkishairlines.concepts.shop.models.Account.Builder clearPhoneNumber() {
      phoneNumber = null;
