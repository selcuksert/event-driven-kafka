...
public class Inventory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3618534554018962378L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Inventory\",\"namespace\":\"com.corp.concepts.shop.models\",\"fields\":[{\"name\":\"itemId\",\"type\":\"long\"},{\"name\":\"count\",\"type\":\"int\"}]}");
   ...
   */
  public static com.corp.concepts.shop.models.Inventory.Builder newBuilder() {
    return new com.corp.concepts.shop.models.Inventory.Builder();
  }
   ...
   * @return A new Inventory RecordBuilder
   */
  public static com.corp.concepts.shop.models.Inventory.Builder newBuilder(com.corp.concepts.shop.models.Inventory.Builder other) {
    if (other == null) {
      return new com.corp.concepts.shop.models.Inventory.Builder();
    } else {
      return new com.corp.concepts.shop.models.Inventory.Builder(other);
    }
  }
   ...
   * @return A new Inventory RecordBuilder
   */
  public static com.corp.concepts.shop.models.Inventory.Builder newBuilder(com.corp.concepts.shop.models.Inventory other) {
    if (other == null) {
      return new com.corp.concepts.shop.models.Inventory.Builder();
    } else {
      return new com.corp.concepts.shop.models.Inventory.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Inventory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.corp.concepts.shop.models.Inventory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.corp.concepts.shop.models.Inventory other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.itemId)) {
        this.itemId = data().deepCopy(fields()[0].schema(), other.itemId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.corp.concepts.shop.models.Inventory.Builder setItemId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.corp.concepts.shop.models.Inventory.Builder clearItemId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.corp.concepts.shop.models.Inventory.Builder setCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.corp.concepts.shop.models.Inventory.Builder clearCount() {
